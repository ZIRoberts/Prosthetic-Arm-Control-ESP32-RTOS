 ...
 *      created in collaboration with York College of Pennsylvania Capstone Course
 */
...
void PACFSRFeedback::calculateFeedbackGrams() {
    ...
    thumbFeedbackGrams =  pow((271/(47000*((3.3/(thumbFeedbackRaw/1000)) -1))),(1/0.69));
    indexFeedbackGrams =  pow((271/(47000*((3.3/(indexFeedbackRaw/1000)) -1))),(1/0.69));
    middleFeedbackGrams =  pow((271/(47000*((3.3/(middleFeedbackRaw/1000)) -1))),(1/0.69));
    ringFeedbackGrams =  pow((271/(47000*((3.3/(ringFeedbackRaw/1000)) -1))),(1/0.69));
    pinkyFeedbackGrams =  pow((271/(47000*((3.3/(pinkyFeedbackRaw/1000)) -1))),(1/0.69));
}
