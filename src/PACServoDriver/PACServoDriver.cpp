 ...
 *      prosthetic arm created in collaboration with York College of Pennsylvania
 *      Capstone Course
 */
...
/**
 * @brief Hand closes until all fingers are closed or an object is within the hand
 * 
 */
