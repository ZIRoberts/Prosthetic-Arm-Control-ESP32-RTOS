...
#define FINGER_RING_GPIO 41
#define FINGER_MIDDLE_GPIO 40
#define FINGER_INDEX_GPIO 39
...
#define FINGER_PINKY_DRIVE_LIMIT 205
#define FINGER_RING_DRIVE_LIMIT 205
#define FINGER_MIDDLE_DRIVE_LIMIT 205
