...
/*ESP32 S3 Support is NOT native to this libary, It was added by Zachary
  Roberts, to support the direction of the project with implementing a ESp32S3.
  It was written based off of the rest of the library and ESP32S3 IDF
  configurations*/
...
// Calculate ADC characteristics i.e. gain and offset factors
  ...
  esp_adc_cal_characterize(unit, ADC_ATTEN_DB_11, ADC_WIDTH_BIT_12, V_REF,
                           &characteristics);
#else
...
#ifdef ESP_IDF_VERSION
#if ESP_IDF_VERSION >= ESP_IDF_VERSION_VAL(3, 1, 0)
  esp_adc_cal_characterize(unit, ADC_ATTEN_DB_11, ADC_WIDTH_BIT_13, V_REF,
                           &characteristics);
#else
  esp_adc_cal_get_characteristics(V_REF, ADC_ATTEN_DB_11, ADC_WIDTH_BIT_12,
                                  &characteristics);
